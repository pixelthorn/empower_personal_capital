...
def get_email():
    ...
    if not email:
        print(
            "You can set the environment variables for PEW_EMAIL and PEW_PASSWORD so the prompts don't come up every time"
        )
...
def main():
    ...
    print(
        "Number of transactions between {0} and {1}: {2}".format(
